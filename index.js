...
const prefix = '.';
const ownerNumber = ['94769421870']; // ඔයාගේ no එක දාන්න 🙄
...
async function connectToWhatsApp() {
    ...
    console.log("Connecting HASI-MD bot 🧬...");
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
           ...
           conn.newsletterFollow("120363409736868943@newsletter") // මේකට ඔයාගේ channel jid එක දාන්න
           console.log(" CHANNEL FOLLOW ✅")
           let up = `HASI-MD connected successful ✅\n\nPREFIX: ${prefix}`; // වෙනස් කරන්නහ්
           conn.sendMessage("94769421870@s.whatsapp.net", { image: { url: `https://i.ibb.co/r2DhffPt/134f9081fc93.jpg` }, caption: up }) // වෙනස් කරන්නහ්
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_READ_STATUS === "true"){
      ...
      if (timeDiff <= maxTime) {
        ...
        try {
          ...
          let rep = `Status seen by HASI-MD 💙`; // වෙනස් කරගන්නන 
    ...
    conn.sendMessage(from, {
        ...
        contextInfo: {
            ...
            // මේ ටිකම හදාගන්න 
                ...
                thumbnailUrl: `https://i.ibb.co/r2DhffPt/134f9081fc93.jpg`,
                mediaType: 1,
